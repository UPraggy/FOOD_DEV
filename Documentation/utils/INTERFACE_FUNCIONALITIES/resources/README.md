This document is responsible for storing the images and fonts used in the python program so that the interface can understand and be able to search and use.
