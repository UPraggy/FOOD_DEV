...
```
![image](https://user-images.githubusercontent.com/100146657/160429199-ac9c2535-3c72-4c05-84c3-1a5b19de0578.png)

```python
Variable Name = lmm_btn_o
```
![image](https://user-images.githubusercontent.com/100146657/160429305-37ab0e96-08da-4c9f-a330-bb4165a5bcec.png)
```python
Variable Name = lmm_btn_about
```
...
```python
Variable Name = lmc_lb_title
```
![image](https://user-images.githubusercontent.com/100146657/160430788-f10391f2-223d-4206-8653-df4dbfcaebb5.png)

```python
Variable Name = lmc_btn_r
```
![image](https://user-images.githubusercontent.com/100146657/160430847-6b743af0-86e2-4b02-8eea-12221afb25b9.png)

```python
Variable Name = lmc_btn_v
```
![image](https://user-images.githubusercontent.com/100146657/160430889-574ecd0c-9e1f-4c77-81ca-19306c219eff.png)

```python
Variable Name = lmc_btn_u
```
![image](https://user-images.githubusercontent.com/100146657/160430930-49cb7a06-0013-4e9d-8f26-bca949f20e45.png)

```python
Variable Name = lmc_btn_d
```
![image](https://user-images.githubusercontent.com/100146657/160430963-5995e7f8-d36e-4f47-b2b0-d505d4bfe777.png)
...
```python
Variable Frame = rmcv_slct_f1
Variable Button = rmcv_slct_btn
Variable LineEdit = rmcv_slct_src
```
